# IT Ops, Vendors, and BI Adoption (SnowTelco)

Use these reference points for Snowflake Intelligence questions in the SnowTelco demo. All amounts in GBP unless stated.
...
- SnowTelco Openreach: £2.2M (Connectivity Provider)
- SnowTelco Business: £1.9M (Connectivity Provider)
