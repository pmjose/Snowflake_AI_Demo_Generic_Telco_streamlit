...
**SnowTelco Group PLC - Technology Alliance**
...
| Parties | SnowTelco Group PLC / Cisco Systems UK Ltd |
...
| Product | Description | SnowTelco Role |
|---------|-------------|------------|
| Webex for SnowTelco | UCaaS platform | Reseller/Partner |
...
| Requirement | SnowTelco Commitment |
|-------------|------------------|
...
| Level | Cisco Contact | SnowTelco Contact |
|-------|---------------|---------------|
| 1 | TAC | NOC |
