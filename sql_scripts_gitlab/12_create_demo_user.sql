...
CREATE USER IF NOT EXISTS SNOWTELCOV2
    LOGIN_NAME = 'snowtelcov2'
    DISPLAY_NAME = 'SnowTelco Demo User'
    FIRST_NAME = 'SnowTelco'
    LAST_NAME = 'Demo'
    EMAIL = 'demo@snowtelco.com'
    PASSWORD = 'snowflake2026'
    DEFAULT_ROLE = SNOWTELCO_V2_DEMO
    DEFAULT_WAREHOUSE = SNOWTELCO_V2_DEMO_WH
    MUST_CHANGE_PASSWORD = FALSE
    COMMENT = 'SnowTelco V2 Demo User';

-- =====================================================
-- STEP 2: Grant Demo Role to User
-- =====================================================

GRANT ROLE SNOWTELCO_V2_DEMO TO USER SNOWTELCOV2;
...
ALTER USER SNOWTELCOV2 SET DEFAULT_SECONDARY_ROLES = ('ALL');
...
ALTER USER SNOWTELCOV2 SET DISABLE_MFA = TRUE;

-- Allow MFA bypass for 24 hours (1440 minutes)
ALTER USER SNOWTELCOV2 SET MINS_TO_BYPASS_MFA = 1440;
...
DESCRIBE USER SNOWTELCOV2;

-- Check grants to user
SHOW GRANTS TO USER SNOWTELCOV2;
